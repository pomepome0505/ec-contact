...
管理画面URL：https://lifestyle-mart-inquiry.com/
...
### 2. GitHub Actions × OIDC認証によるセキュアなCI/CDパイプライン
...
### 3. ECSデプロイサーキットブレーカーによる自動ロールバック
